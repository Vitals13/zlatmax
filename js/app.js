(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (document.documentElement.classList.contains("categories-open")) document.documentElement.classList.remove("categories-open");
            ...
            if (document.querySelector(".mainslider__slider")) new core(".mainslider__slider", {
                ...
                on: {
                    init: function(swiper) {
                        ...
                        const allSlidesItems = document.querySelectorAll(".slide-mainslider:not(.swiper-slide-duplicate)");
        ...
        const categoriesBlocks = document.querySelectorAll(".submenu-categories__block");
        if (categoriesBlocks.length) categoriesBlocks.forEach((categoriesBlock => {
            const categoriesBlockItem = categoriesBlock.querySelectorAll(".submenu-categories__items").length;
            categoriesBlock.classList.add(`submenu-categories__block_${categoriesBlockItem}`);
        }));
        function documentActions(e) {
            ...
            if (targetElement.closest(".menu-top-header__link_categories")) {
                document.documentElement.classList.add("categories-open");
                e.preventDefault();
            }
            if (targetElement.closest(".menu-categories__back")) {
                document.documentElement.classList.remove("categories-open");
            ...
            if (targetElement.closest(".submenu-categories__back")) {
                document.documentElement.classList.remove("submenu-open");
                document.querySelector("._submenu-active") ? document.querySelector("._submenu-active").classList.remove("_submenu-active") : null;
                document.querySelector("._submenu-open") ? document.querySelector("._submenu-open").classList.remove("_submenu-open") : null;
                e.preventDefault();
